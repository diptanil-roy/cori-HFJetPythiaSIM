#ifndef __D0JetFilter_h__
#define __D0JetFilter_h__
...
class D0JetFilter : public StarFilterMaker
{
public:
  D0JetFilter( const char* name = "partfilt");
  virtual ~D0JetFilter(){ /* nada */ }
  ...
  // void AddTrigger(double _zmin, double _zmax);

  // lowz = _zmin; highz = _zmax;
